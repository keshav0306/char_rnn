...
rnn = RNN(word_to_idx, 256, 256, "lstm")
...
for i in range(epochs):
    if(lwflag):
        data = load_data_letter(word_to_idx, file_name, lines_count=2, max_train=50)
    else:
        data = load_data(word_to_idx, file_name, lines_count=2, max_train=50)
