...
class CaptioningSolver(object):
    ...
    def __init__(self, model, data_file, word_to_idx, lines_count, max_train, **kwargs):
        """
        ...
        self.minibatch = load_data(
            self.word_to_idx, self.data_file, self.lines_count, self.max_train, hardcode =1001
        )
